...
>  "wise words = you are born to be great"

[song link](https://www.youtube.com/watch?v=0DlCqC4iloY)
  
## my semester
  
  | Class | Class Name | Professor |
  |:---- |:----|:----|
  |**Data 2401** |*Data science* | Katherine Shoemaker
  |**Math 2305** |*Discrete Math* | Mukesh Kumar
  |**Math 2307** |*Linear Algebra* | Katarina Jegdic
  |**Math 3302** |*Prob & statistics* | Youn-Sha Chan
  
### I recommend listening to burna boy. He's an afrobeat musician and his songs are very unique
_burna boy_
*Give me distance, I dey enter my zone as I dey my own opolo po ju La ilaha illa allah calm down*
